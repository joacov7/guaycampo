...
import { Home, CalendarDays, FileText, DollarSign, Warehouse, ClipboardList, Wallet, FileSignature, TrendingUp, Award, ReceiptText } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/portal/mis-remitos', label: 'Remitos', icon: ReceiptText },
